...
public class ReserveEventIntegrationTest {
    ...
    public void reserve_parter_EventDayDoesNotExist() throws EventDayDoesNotExistOrStateIsNotValid, SeatIsNotAvailable, SectorNotFound, SectorWrongType, LocationSectorsDoesNotExistForLocation, NumberOfTicketsException, WriterException, ReservationIsNotPossible, IOException {
    ...
    @Test(expected = EventDayDoesNotExistOrStateIsNotValid.class)
    public void reserve_parter_EventDayDoesNotExist_DateAfter() throws EventDayDoesNotExistOrStateIsNotValid, SeatIsNotAvailable, SectorNotFound, SectorWrongType, LocationSectorsDoesNotExistForLocation, NumberOfTicketsException, WriterException, ReservationIsNotPossible, IOException {
    ...
    @Test(expected = EventDayDoesNotExistOrStateIsNotValid.class)
    public void reserve_parter_StateIsNotValid() throws EventDayDoesNotExistOrStateIsNotValid, SeatIsNotAvailable, SectorNotFound, SectorWrongType, LocationSectorsDoesNotExistForLocation, NumberOfTicketsException, WriterException, ReservationIsNotPossible, IOException {
    ...
    @Test(expected = EventDayDoesNotExistOrStateIsNotValid.class)
    public void reserve_grandstand_EventDayDoesNotExist() throws EventDayDoesNotExistOrStateIsNotValid, SeatIsNotAvailable, SectorNotFound, SectorWrongType, LocationSectorsDoesNotExistForLocation, NumberOfTicketsException, WriterException, ReservationIsNotPossible, IOException {
    ...
    @Test(expected = EventDayDoesNotExistOrStateIsNotValid.class)
    public void reserve_grandstand_EventDayDoesNotExist_DateAfter() throws EventDayDoesNotExistOrStateIsNotValid, SeatIsNotAvailable, SectorNotFound, SectorWrongType, LocationSectorsDoesNotExistForLocation, NumberOfTicketsException, WriterException, ReservationIsNotPossible, IOException {
    ...
    @Test(expected = EventDayDoesNotExistOrStateIsNotValid.class)
    public void reserve_grandstand_StateIsNotValid() throws EventDayDoesNotExistOrStateIsNotValid, SeatIsNotAvailable, SectorNotFound, SectorWrongType, LocationSectorsDoesNotExistForLocation, NumberOfTicketsException, WriterException, ReservationIsNotPossible, IOException {
