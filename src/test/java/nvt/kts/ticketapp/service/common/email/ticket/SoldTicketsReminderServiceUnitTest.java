...
public class SoldTicketsReminderServiceUnitTest {

    @Autowired
    private SoldTicketsReminderService soldTicketsReminderService;
    ...
    @Test
    public void sendReminderForSoldTicket_Positive() throws IOException, WriterException {
        soldTicketsReminderService.sendReminderForSoldTicket(USER_EMAIL, ticket);
        verify(emailClient, times(1)).generateQrCode(String.valueOf(EXISTING_TICKET_ID));

        soldTicketsReminderService.sendReminderForSoldTicket(USER_EMAIL, ticket_02);
